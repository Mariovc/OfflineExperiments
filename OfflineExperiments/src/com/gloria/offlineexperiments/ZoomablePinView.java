...
//	}
	...
	public void setNumberView (TextView numberView) {
		...
		numberView.setTextSize(getResources().getDimension(R.dimen.pin_number_text_size));
		setNumber();
	}
	...
	private void setNumber () {
		...
		int textSizeRes;
		if (number / 10 > 0) {
			textSizeRes = R.dimen.pin_number_text_size_two_digits;
		} else {
			textSizeRes = R.dimen.pin_number_text_size;
		}
		numberView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimension(textSizeRes));
		setTextMargins();
	}
